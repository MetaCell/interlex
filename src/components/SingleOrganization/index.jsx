            ...
            <Box sx={{
                ...
                <Box display='flex' alignItems='center' justifyContent='space-between'>
                    ...
                    <Stack direction="row" spacing="1rem" alignItems="center">
                        <Button type="string" color="secondary" startIcon={<EditNoteIcon />}>
                            View organization curies
                        </Button>
                        <Divider orientation="vertical" flexItem sx={{ borderColor: "#DADDDC" }} />
                        <Button type="string" color="error" startIcon={<ExitToAppIcon />} sx={{ padding: 0 }}>
                            Leave
                        </Button>
                    ...
                    {loading ? <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    </Box> : <Grid container spacing='2.75rem'>
                        {
                            terms.map((term, index) => (
                                <OrganizationCard term={term} key={index} />
                            ))
                        }
                    </Grid>}
