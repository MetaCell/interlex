...
// NervoSensus group-by shortcuts appended to the stored URL as a query param (spec §4.3).
export const NERVOSENSUS_GROUP_BY = ["morphology", "electrophysiology", "markers"] as const;
