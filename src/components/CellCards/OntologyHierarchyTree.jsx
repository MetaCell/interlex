...
//
// The label is a real link so the term opens in a new tab (design decision), which also gets
// middle-click and keyboard activation for free. It carries the term's own colour rather than
// the link colour — the design draws these as plain text — and stops the click from reaching
// the item, so opening a term never doubles as expanding it. Expansion stays on the chevron.
