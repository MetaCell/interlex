...
export const getGetUserTermsResponseMock = () => ((() => [
  {
    "@context": {
...
export const getGetUserOrganizationsResponseMock = () => ((() => [
  {
  ...
  },
  {
    ...
    id: "org_2",
    url: "https://dknet.org",
    icon: "/logos/NIDDK.svg"
  }
])())

export const getGetUserForksResponseMock = () => ((() => {
  return [
    {
      name: "ForkPB08",
      origin: {
        name: "ForkPB08",
        url: "fork1.example.com"
      },
      destination: {
        name: "Central Nervous System",
        url: "fork1.destination.com",
        tag: "Spark Anatomical Work Group"
      },
      status: "requested",
      date: "01/01/2005 2024-06-05T18:16:38",
      request_url: "fork.example.com"
    },
    {
      name: "ForkPB09",
      origin: {
        name: "ForkPB09",
        url: "fork2.example.com"
      },
      destination: {
        name: "Central Nervous System",
        url: "fork2.destination.com",
        tag: "Spark Anatomical Work Group"
      },
      status: "approved",
      date: "01/01/2005 2024-06-05T18:16:38",
    ...
    },
    {
      ...
      origin: {
        name: "ForkPB10",
        url: "fork3.example.com"
      },
      destination: {
        name: "Central Nervous System",
        url: "fork3.destination.com",
        tag: "Spark Anatomical Work Group"
      },
      status: "rejected",
      date: "01/01/2005 2024-06-05T18:16:38",
...
export const getGetOrganizationsTermsResponseMock = () => ((() => [
  {
    "@context": {
      "owl": "http://www.w3.org/2002/07/owl#",
      "rdf": "http://www.w3.org/1999/02/22-rdf-syntax-ns#",
...
export const getGetUserTermsMockHandler = (overrideResponse?: Terms) => {
  return http.get('*/operations/getUser/:id/terms', async () => {
    await delay(1000);
    return new HttpResponse(JSON.stringify(overrideResponse !== undefined ? overrideResponse : getGetUserTermsResponseMock()),
      {
        status: 200,
        headers: {
          'Content-Type': 'application/json',
...
export const getGetUserOrganizationsMockHandler = (overrideResponse?: Organizations) => {
  return http.get('*/operations/getUser/:id/organizations', async () => {
    await delay(1000);
    return new HttpResponse(JSON.stringify(overrideResponse !== undefined ? overrideResponse : getGetUserOrganizationsResponseMock()),
      {
        status: 200,
        headers: {
          'Content-Type': 'application/json',
...
export const getGetUserForksMockHandler = (overrideResponse?: Forks) => {
  return http.get('*/operations/getUser/:id/forks', async () => {
    await delay(1000);
    return new HttpResponse(JSON.stringify(overrideResponse !== undefined ? overrideResponse : getGetUserForksResponseMock()),
      {
        status: 200,
        headers: {
          'Content-Type': 'application/json',
...
export const getGetMatchTermsMockHandler = (overrideResponse?: Terms) => {
  return http.get('*/:group/match/:term', async () => {
    await delay(1000);
...
export const getSearchAllMockHandler = (overrideResponse?: unknown) => {
  return http.get('*/:group/search/:term', async () => {
    await delay(1000);
    return new HttpResponse(JSON.stringify(overrideResponse !== undefined ? overrideResponse : getSearchAllResponseMock()),
      {
        status: 200,
        headers: {
          'Content-Type': 'application/json',
